...
<h4 align="center">Install node.js (v12.18.0)</h4>
  ...
  <h4 align="center">run `npm i` from the project root directory (same directory as package.json file) and this will install all required dependencies mentioned in package.json file.</h4>
